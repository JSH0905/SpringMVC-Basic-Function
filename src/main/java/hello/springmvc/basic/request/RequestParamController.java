...
public class RequestParamController {
     ...
     * String, int, Integer 와 같은 단순 타입이면 스프링이 @RequestParam로 처리
     * 예제 코드의 HelloData처럼 내가 직접 만든 객체들은 @ModelAttribute로 처리. 단, HttpServletRequest와 같은 argument resolver로 지정해준 타입은 예외.
     */
    @ResponseBody
